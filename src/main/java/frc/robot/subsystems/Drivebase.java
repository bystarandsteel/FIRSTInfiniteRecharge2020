...
public class Drivebase {
    ...
    public void initialize() {
        ...
        leftOne.setOpenLoopRampRate(0.75);
        leftTwo.setOpenLoopRampRate(0.75);
        rightOne.setOpenLoopRampRate(0.75);
        rightTwo.setOpenLoopRampRate(0.75);
    ...
    public void arcadeDrive() {
        ...
        if (Math.abs(Robot.driver.getX(Robot.right)) > 0.05) {
            turn = Robot.driver.getX(Robot.right) * 0.9;
        }
